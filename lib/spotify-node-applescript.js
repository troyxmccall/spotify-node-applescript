...
exports.getArtwork = function(callback) {
  this.getTrack(function(error, track) {
    swapi.getTrack(track.id.replace(/spotify:track:/g, ''))
      .then(function(data) {
        return callback(null, data.body.album.images[0].url);
      }, function(err) {
        console.error(err);
      });
  });
